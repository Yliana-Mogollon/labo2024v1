...
AgregaVarRandomForest <- function(
  ...
  # Obtener las columnas que contienen valores nulos en dataset - Línea agregada al script original
  columnas_con_nulos <- colnames(dataset)[colSums(is.na(dataset)) > 0]
  
  # Eliminar las columnas con nulos de campos_buenos - Línea agregada al script original
