...
DR_drifting_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$variables_intrames <- TRUE #YM se cambió de false a true
  # valores posibles
  #  "ninguno", "rank_simple", "rank_cero_fijo", "deflacion", "estandarizar"
  param_local$metodo <- "rank_simple" #YM se cambió de rank_cero_fijo
...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$RandomForest$num.trees <- 30 #YM cambió de 20 a 30
  param_local$RandomForest$max.depth <- 6 #YM cambió de 4 a 6
